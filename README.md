...
<head>
    ...
    <title>Dreamy Destinations</title>
    <link rel="icon" type="favicon"
        href="https://png.pngtree.com/background/20230410/original/pngtree-travel-around-the-world-background-picture-image_2385120.jpg">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#" style="color: greenyellow;"><img
                    src="https://e7.pngegg.com/pngimages/345/54/png-clipart-green-location-icon-illustration-computer-icons-google-maps-google-map-maker-adress-angle-leaf.png"
                    alt="Bootstrap" width="30" height="32"> Dreamy Destinations</a>
    ...
    <div class="Cards row" id="imp card">
        ...
        <div class="card" style="width: 19rem;">
            <img src="https://theindianwire.com/wp-content/uploads/2017/05/Pink-city.jpg" class="card-img-top"
                alt="...">
            <div class="card-body">
